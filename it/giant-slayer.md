...
1. Håkon è un costruttore di navi vichinghe, ma desidera diventare
   ...
   * il capitano di una nave
   ...
   perché vuole una vita

   * con più avventura
   * con più pericoli
   * in mare, non sulla terraferma
...
2. La nave viene attaccata da un calamaro gigante. Håkon riesce ad aiutare perché
   ...
   * rimane calmo di fronte al pericolo
...
5. Il finale rivela che Håkon
   ...
   * è diventato un guerriero rispettato
   * è tornato a costruire navi
   * vuole che suo nipote diventi un guerriero
   * è stato punito per essere salito di nascosto sulla nave