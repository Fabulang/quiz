...
1. Filippo travaille sur un tableau. Le tableau représente

   * une vue de la ville
   * une vue du paysage autour de la ville
   * une vue de plusieurs rues importantes
   * le portrait du mécène
...
2. Comment le travail est-il organisé dans l'atelier ?
   ...
   * se contente de donner des instructions
   * peint les arrière-plans
...
3. Le mécène veut placer le tableau dans la salle du Conseil, parce que
   ...
   * cela augmentera sa renommée et son influence
   * il souhaite entrer au Conseil
